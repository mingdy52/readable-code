...
public class MinesweeperGame {
    ...
    private static void actOnCell(String cellInput, String userActionInput) {
        ...
        if (doesUserChooseToOpenCell(userActionInput)) {
            if (isLandMineCell(selectedRowIndex, selectedColIndex)) {
                ...
                changeGameStatusToLose(selectedRowIndex, selectedColIndex);
                return;
            }
    ...
    private static void changeGameStatusToLose(int selectedRowIndex, int selectedColIndex) {
        gameStatus = -1;
    }
    ...
    private static void showGameStartCommnets() {
        System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
